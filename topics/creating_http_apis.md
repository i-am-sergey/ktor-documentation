...
2. Create a `Customer.kt` file in the `models` package and add the following code:
   ...
   ```kotlin
   ```
   {src="snippets/tutorial-http-api/src/main/kotlin/com/example/models/Customer.kt" lines="1-6"}
...
```kotlin
```
{src="snippets/tutorial-http-api/src/main/kotlin/com/example/routes/CustomerRoutes.kt" lines="1-18,44-45"}
...
```kotlin
```
{src="snippets/tutorial-http-api/src/main/kotlin/com/example/plugins/Routing.kt" lines="1-9,13-14"}
...
```kotlin
```
{src="snippets/tutorial-http-api/src/main/kotlin/com/example/models/Order.kt" lines="1-9"}
...
```kotlin
```
{src="snippets/tutorial-http-api/src/main/kotlin/com/example/routes/OrderRoutes.kt" lines="1-16"}
